...
ServerEvents.recipes(event => {
  ...
  // Injection
  event.recipes.mekanism.injecting(Item.of('farmersdelight:smoked_ham', "{display:{Name:'[{\"translate\":\"item.valhelsia.steamed_ham\",\"italic\":false}]',Lore:['[{\"translate\":\"item.valhelsia.steamed_ham.lore\",\"italic\":false}]']}}"), 'farmersdelight:ham', {tag: 'mekanism:water_vapor', amount: 1}).id(`${ID_PREFIX}injecting/steamed_ham`);
